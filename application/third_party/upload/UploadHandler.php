...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'max_number_of_files' => 'Número máximo de archivos excede',
        'max_width' => 'La imagen supera el ancho máximo',
        'min_width' => 'La imagen requiere un ancho mínimo',
        'max_height' => 'La imagen sobrepasa la altura máxima',
        'min_height' => 'La imagen requiere una altura mínima',
        'abort' => 'La carga de archivos abortado',
   ...
   var $folder = null;
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null,$folder ,$pagina) {
        $this->folder = $folder;
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url().'/convocatoria/subir?data='.$pagina,
